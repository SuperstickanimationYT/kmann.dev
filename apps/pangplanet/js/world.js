...
export const SCIENCE = { sellPrice: 5, visit: 60, landing: 30, blackHole: 50, flyby: { base: 40, perPlanet: 10 }, sample: { other: 20, gas: 30, crystals: 60, stardust: 150 } };
export const SOLAR_SAIL = { cost: 250, pushAtSurface: 0.13, range: 1e8, aimRadius: 1.5e6, minLight: 1e-3 };
